<%@ Page Title="" Language="C#" MasterPageFile="~/Master.master" AutoEventWireup="true" CodeFile="PrintBooking.aspx.cs" Inherits="PrintBooking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="panel" runat="server" BorderStyle="Double" BorderColor="Black" HorizontalAlign="Center" Height="389px" Width="618px">
